...
export default function App() {
    ...
    const [rollHistory, setRollHistory] = React.useState(localStorage.getItem("hist") || [])

    let diceAudio = new Audio("/rollDice.mp3")
    let winAudio = new Audio("/winGame.mp3")
    ...
    React.useEffect(() => {
        localStorage.setItem("hist", rollHistory)
    }, [rollHistory])
    ...
    return (
        <div className="top">
            <main>
                ...
                <p className="description">Play with sound for a better experience!</p>
